  ...
  <header class="top-bar">
    ...
    <div class="header-middle">
      <div class="button-group">
        ...
        <span class="divider"></span>
        <button @click="goToPage('/logs')" :class="{ active: currentPath === '/logs' }">
...
import { House, VideoCameraFilled, BellFilled, QuestionFilled, Document } from '@element-plus/icons-vue'
